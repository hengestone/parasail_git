...
package body PSC.Trees.Semantics.Translator is
   ...
   type Info_Kind_Enum is (Type_Parameters_Kind, Actuals_Of_Formals_Kind,
     Components_Kind, Nested_Types_Kind, Nested_Consts_Kind, Operations_Kind,
   ...
   begin
      ...
      when Type_Desc_Info_Kinds =>
         ...
         begin
            ...
            when Nested_Consts_Kind =>
               Result := Type_Desc.Num_Nested_Consts;
      ...
      when Type_Desc_Info_Kinds =>
         ...
         begin
            ...
            when Nested_Consts_Kind =>
               declare
                  Info : Const_Info
                    renames Type_Desc.Nested_Consts (Index);
               begin
                  --  Create the Const_Info object
