...
package body PSC.Vectors is
   ...
   --  Divisors to use based on level in Vector tree
   Level_1_Capacity : constant Vec_Capacity := Sub_Vec_Capacity;
   Level_2_Capacity : constant Vec_Capacity := Vec_Capacity'Min
             (Vec_Capacity'Last,
              Vec_Of_Vec_Capacity * Sub_Vec_Capacity);
   Level_3_Capacity : constant Vec_Capacity := Vec_Capacity'Min
             (Vec_Capacity'Last,
              Vec_Of_Vec_Capacity ** 2 * Sub_Vec_Capacity);

   --  Array of level capacities
