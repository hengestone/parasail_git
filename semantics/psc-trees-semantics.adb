...
package body PSC.Trees.Semantics is
   ...
   begin
      ...
      Put_Line (File, "Copyright (C) 2011-2019, AdaCore, New York NY, USA");
      ...
      case Languages.Language is
         ...
         when Languages.Ada_Ish =>
            ...
            Put_Line (File,
               " see link at bottom of http://www.sparkel.org");
         when Languages.Javallel =>
            Put_Line (File,
               "Report problems on the Javallel discussion forum;");
            Put_Line (File,
               " see link at bottom of http://www.javallel.org");
      end case;
      New_Line (File);
   end Give_Copyright;
   ...
   --  Return prefix of Qualified_Name or Selection
   --  Returns Null_Optional_Tree if given an Identifier
   --  Requires: Name is a Qualified_Name, a Selection, or an Identifier
   ...
   --  Return suffix of Qualified_Name or Selection (Id or Selector)
