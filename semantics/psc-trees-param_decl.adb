         ...
         case Kind is
            ...
            when Var_Param =>
               Messages.Parser_Error
                 ("Default not permitted for ""var"" parameter.");
            when Ref_Param_Kinds =>
               Messages.Parser_Error
                 ("Default not permitted for ""ref"" parameter.");
            when Global_Param_Kinds =>
               Messages.Parser_Error
                 ("Default not permitted for ""global"" parameter.");
         end case;
      end if;
