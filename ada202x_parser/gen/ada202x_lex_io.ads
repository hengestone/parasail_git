...
procedure YY_INPUT_default(buf: out unbounded_character_array; result: out integer; max_size: in integer);
type YY_INPUT_Ptr is access procedure (buf: out unbounded_character_array; result: out integer; max_size: in integer);
YY_INPUT : YY_INPUT_Ptr := YY_INPUT_default'Access; -- May be overridden
