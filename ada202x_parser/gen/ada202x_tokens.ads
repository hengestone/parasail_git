...
package Ada202x_Tokens is
    ...
    type Token is
        (End_Of_Input, Error, ',', ';',
         ...
         Others_Kw, Package_Kw, Parallel_Kw,
         Private_Kw, Proc_Kw, Protected_Kw,
         Queued_Kw, Range_Kw, Record_Kw,
         Ref_Kw, Rem_Kw, Return_Kw,
         Reverse_Kw, Some_Kw, Subtype_Kw,
         Tagged_Kw, Then_Kw, Type_Kw,
         Until_Kw, Use_Kw, Var_Kw,
         When_Kw, While_Kw, With_Kw,
         Xor_Kw );
