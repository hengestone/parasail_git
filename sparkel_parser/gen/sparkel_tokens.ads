...
package Sparkel_Tokens is
    ...
    type Token is
        (End_Of_Input, Error, ',', ';',
         ...
         '>', '|', '&',
         '=', Prime, L_Assert,
         R_Assert, L_Set, R_Set,
         Compare, Eq, Neq,
         Geq, Leq, Lshift,
         Power, Assign, Swap,
         Move, Combine_Move, Dot_Dot,
         Open_Closed_Interval, Open_Interval, Closed_Open_Interval,
         Double_Colon, Refers_To, Gives,
         Implies, Parallel, Plus_Assign,
         Minus_Assign, Times_Assign, Divide_Assign,
         Power_Assign, Combine_Assign, Ampersand_Assign,
         And_Assign, Or_Assign, Xor_Assign,
         Lshift_Assign, Rshift_Assign, Newline,
         Outdent, Indent, Eol_Colon,
         Plus_Based_Op, Minus_Based_Op, Mul_Based_Op,
         Div_Based_Op, Exp_Based_Op, Or_Based_Op,
         And_Based_Op, Xor_Based_Op, Not_Based_Op,
         Lshift_Based_Op, Rshift_Based_Op, Combine_Based_Op,
         Char_Literal, Enum_Literal, Integer_Literal,
         Real_Literal, String_Literal, Identifier,
         Abs_Kw, Abstract_Kw, All_Kw,
         And_Kw, Assert_Kw, Begin_Kw,
         Block_Kw, Body_Kw, Case_Kw,
         Class_Kw, Concurrent_Kw, Const_Kw,
         Constant_Kw, Continue_Kw, Declare_Kw,
         Delta_Kw, Digits_Kw, Each_Kw,
         Else_Kw, Elsif_Kw, End_Kw,
         Exit_Kw, Exports_Kw, Extends_Kw,
         For_Kw, Forward_Kw, Func_Kw,
         Function_Kw, Generic_Kw, Global_Kw,
         If_Kw, Implements_Kw, Import_Kw,
         In_Kw, Interface_Kw, Is_Kw,
         Lambda_Kw, Limited_Kw, Locked_Kw,
         Loop_Kw, Mod_Kw, New_Kw,
         Not_Kw, Null_Kw, Of_Kw,
         Op_Kw, Opt_Kw, Optional_Kw,
         Or_Kw, Others_Kw, Package_Kw,
         Parallel_Kw, Private_Kw, Proc_Kw,
         Procedure_Kw, Protected_Kw, Queued_Kw,
         Range_Kw, Record_Kw, Ref_Kw,
         Rem_Kw, Return_Kw, Reverse_Kw,
         Some_Kw, Subtype_Kw, Tagged_Kw,
         Then_Kw, Type_Kw, Until_Kw,
         Use_Kw, Var_Kw, When_Kw,
         While_Kw, With_Kw, Xor_Kw );
