...
package Parasail_Tokens is
    ...
    type Token is
        (End_Of_Input, Error, ',', ';',
         ...
         All_Kw, And_Kw, Begin_Kw,
         Block_Kw, Case_Kw, Class_Kw,
         Concurrent_Kw, Const_Kw, Continue_Kw,
         Each_Kw, Else_Kw, Elsif_Kw,
         End_Kw, Exit_Kw, Exports_Kw,
         Extends_Kw, For_Kw, Forward_Kw,
